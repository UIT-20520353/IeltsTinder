package uit.se122.ieltstinder.constant;
...
public class MessageConstant {
    ...
    public static final String ADDRESS_MAX_LENGTH_ERROR = "error.validate.address.length.max";

    public static final String GENDER_MIN_VALUE_ERROR = "error.validate.gender.value.min";
    public static final String GENDER_MAX_VALUE_ERROR = "error.validate.gender.value.max";
